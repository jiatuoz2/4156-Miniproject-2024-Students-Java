...
public class RouteController {
    ...
    try {
      ...
      if (!departmentMapping.containsKey(deptCode.toUpperCase(Locale.ENGLISH))) {
        ...
        return new ResponseEntity<>(departmentMapping.get(
            deptCode.toUpperCase(Locale.ENGLISH)).toString(),
            HttpStatus.OK);
      }
  ...
  /**
   * Attempts to set the enrolled student count for the specified course.
   *
   * @param deptCode       A {@code String} representing the department.
   *
   * @param courseCode     A {@code int} representing the course within the department.
   *
   * @param count          A {@code int} representing the new student count for the course.
   *
  ...
  /**
   * Attempts to change the location for the specified course.
   *
   * @param deptCode       A {@code String} representing the department.
   *
   * @param courseCode     A {@code int} representing the course within the department.
